...
st.set_page_config(page_title="Classification — Entraînement", layout="wide")
st.title("Classification d'images — Entraînement")
st.markdown(
...
if payload:
    try:
        ...
        st.error(
            ...
            "Réimportez-le depuis **Classification — Dataset**."
        )
        dataset = None
...
if dataset is None:
    if not training_locked:
        st.warning(
            ...
            "Importez-en un sur **Classification — Dataset**."
        )
else:
