...
st.set_page_config(page_title="Segmentation — Entraînement", layout="wide")
st.title("Segmentation — Entraînement")
st.markdown(
...
if payload:
    try:
        ...
        st.error(
            ...
            "Réimportez-le depuis **Segmentation — Dataset**."
        )
        dataset = None
...
if dataset is None:
    if not training_locked:
        st.warning(
            ...
            "Importez-en un sur **Segmentation — Dataset**."
        )
else:
